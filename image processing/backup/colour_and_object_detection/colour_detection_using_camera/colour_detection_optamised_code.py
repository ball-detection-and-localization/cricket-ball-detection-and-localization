...
while(1):
	...
	if (radius>10 and radius<409):
		...
		a=1
	if(a>0):
		cv2.putText(frame,'blue',(500,50), font, 4,(255,0,0),2)
	...
	radius1= int(radius1)
	if (radius1>10 and radius1<409):
		font = cv2.FONT_HERSHEY_SIMPLEX
		a=2
		
	if(a>1):
		img1 = cv2.circle(frame,center1,radius1,(0,0,255),2)
		cv2.putText(frame,'RED',(500,50), font, 4,(0,0,255),2)
		t0 = time.clock()
		print ('RED found at',t0)
		cv2.imshow('frame',frame)
		cv2.waitKey(5)
	...
	radius2 = int(radius2)
	if (radius2>10 and radius2<409):
		font = cv2.FONT_HERSHEY_SIMPLEX
		a=3
		
	if(a>2):
		img2 = cv2.circle(frame,center2,radius2,(0,255,0),2)
		cv2.putText(frame,'blue',(500,50), font, 4,(0,255,0),2)
		t0 = time.clock()
		print ('GREEN found at',t0)
		cv2.imshow('frame',frame)
		cv2.waitKey(5)
	...
	if(a>3):
		...
		cv2.putText(frame,'YELLOW',(500,50), font, 4,(0,255,255),2)
		t0 = time.clock()
		print ('YELLOW found at',t0)
		cv2.imshow('frame',frame)
		cv2.waitKey(5)
	...
	if(a>4):
		...
		cv2.putText(frame,'pink',(500,50), font, 4,(255,0,255),2)
		t0 = time.clock()
		print ('pink found at',t0)
		cv2.imshow('frame',frame)
		cv2.waitKey(5)
